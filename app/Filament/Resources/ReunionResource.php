            ...
            ->columnSpanFull(),
                ...
                ->schema([
                    ...
                    ->content(new HtmlString(
                        '<div style="padding: 12px; color: #475569; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px;">Thêm từng lớp, chọn ảnh đại diện nếu cần, rồi upload tối đa 50 ảnh cho album của lớp đó. Ảnh này sẽ hiển thị ở phần “Các lớp” và mở bằng GLightbox theo đúng từng lớp.</div>'
                    ))
                    ->columnSpanFull(),
