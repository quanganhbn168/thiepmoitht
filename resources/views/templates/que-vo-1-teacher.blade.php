    ...
    <footer class="relative overflow-hidden bg-slate-950 px-5 py-12 text-white sm:py-16">
        ...
        <div class="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,.8fr)] lg:items-end">
            <div data-aos="fade-up">
                <p class="text-xs font-bold uppercase tracking-[0.24em] text-yellow-300">Tri ân và hội ngộ</p>
                <h3 class="mt-3 font-serif text-2xl font-bold leading-tight text-yellow-100 sm:text-3xl">Trường THPT Quế Võ Số 1</h3>
                <p class="mt-2 text-sm font-semibold uppercase tracking-[0.2em] text-slate-400">Niên Khóa 1998 - 2001</p>

                <div class="mt-6 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                    <p class="text-xs uppercase tracking-[0.16em] text-slate-500">Trưởng Ban tổ chức</p>
                    <p class="mt-1 font-semibold text-white">Nguyễn Đức Mạnh</p>
                    <a href="tel:0943859166"
            ...
            <div class="lg:text-right" data-aos="fade-up" data-aos-delay="120">
                ...
                <div class="mt-4 flex flex-wrap gap-3 lg:justify-end">
                    <a href="https://zalo.me/share?u={{ urlencode(url('/hop-lop-que-vo-1-teacher')) }}" target="_blank"
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url('/hop-lop-que-vo-1-teacher')) }}" target="_blank"
                ...
                <p class="mt-8 border-t border-white/10 pt-5 text-xs leading-6 text-slate-500">
                    Thiết kế bởi <a href="/" class="font-semibold text-yellow-300 transition hover:text-yellow-200">THT Media</a>
