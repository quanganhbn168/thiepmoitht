            ...
            <div id="hero-section_left">
                <div class="hero-photo-stack">
                    ...
                    <div class="hero-photo second">
                        <img src="{{ $event->hero_photo_2 ?? asset('images/demo/class-2.jpg') }}" alt="Ảnh lớp cũ">
                    </div>
                    <div class="hero-photo third">
                        <img src="{{ $event->hero_photo_3 ?? asset('images/demo/school-2.jpg') }}" alt="Ảnh trường Quế Võ 1">
                    </div>
