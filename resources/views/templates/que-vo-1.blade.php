{{-- Template Name: Họp lớp Quế Võ 1 --}}
    ...
    <footer class="relative overflow-hidden bg-slate-950 px-5 py-12 text-white sm:py-16">
        ...
        <div class="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,.8fr)] lg:items-end">
            <div data-aos="fade-up">
                ...
                <h3 class="mt-3 font-serif text-2xl font-bold leading-tight sm:text-3xl">Trường THPT Quế Võ Số 1</h3>
                <p class="mt-2 font-accent text-2xl text-amber-200">Niên Khóa 1998 – 2001</p>

                <div class="mt-6 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                    <p class="text-xs uppercase tracking-[0.16em] text-slate-500">T/M Ban liên lạc - Trưởng Ban tổ chức</p>
            ...
            <div class="lg:text-right" data-aos="fade-up" data-aos-delay="120">
                ...
                <div class="mt-4 flex flex-wrap gap-3 lg:justify-end">
                    <a href="https://zalo.me/share?u={{ urlencode(url('/hop-lop-nien-khoa-1998-2001-que-vo-1')) }}" target="_blank"
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url('/hop-lop-nien-khoa-1998-2001-que-vo-1')) }}" target="_blank"
